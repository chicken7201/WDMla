...
public enum IconUI {
    ...
    private static final HashMap<String, IconUI> lk = new HashMap<>();
    ...
    /** Creates an icon without a separate background texture region. */
    IconUI(int u, int v, int su, int sv, String symbol) {
        this(u, v, su, sv, -1, -1, -1, -1, symbol);
    }

    /** Creates an icon with optional foreground and background texture regions. */
    ...
    /** Returns the icon registered for a Waila symbol, or the fallback bubble icon. */
